...
// CORREÇÃO 2.1: Implementação da função setupCourseListeners (estava ausente)
function setupCourseListeners() {
    const coursesContainer = document.getElementById('courses-container');
    if (!coursesContainer) return;

    // Lógica para salvar campos de texto simples
...
        const textInputs = [
            { selector: '.course-nome', field: 'nome' },
            { selector: '.course-regioes', field: 'regioes' },
            { selector: '.course-duracao', field: 'duracao' },
            { selector: '.course-alunos', field: 'mediaAlunos' },
            { selector: '.course-divulgacao', field: 'linkDivulgacao' },
            { selector: '.course-conteudo', field: 'linkConteudo' },
            { selector: '.course-tipo-outro', field: 'tipoOutro' }
        ];
...
                    // Se o nome mudar, re-renderiza para atualizar o cabeçalho do curso
                    if (config.field === 'nome') {
                        renderQuestion(currentStep);
                    }
                });
            }
